...
#define VERSION_NUM				1,0,3,0
#define VERSION_LINEAR			1030
#define VERSION_LINEAR_TEXT		TEXT("1030")
#define VERSION_TEXT			TEXT("1.0.3") // This must match the tag pushed on the server minus the "v"
